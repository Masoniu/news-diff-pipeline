...
from src.pipeline.stage1_ingestion.parser import parse_article
from src.pipeline.stage1_ingestion.keywords import extract_keywords
from src.pipeline.common.schemas import Stage1Output
...
def main():
    p = argparse.ArgumentParser(description="Stage 1: Ingestion")
    ...
    if not args.url and not args.html_file:
        p.error("Either --url or --html-file is required")
